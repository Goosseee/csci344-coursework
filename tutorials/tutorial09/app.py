...
def exercise3():
    ...
    if not (search_term and location):
        return '''<p>This url needs a search term AND a location!</p> 
        <p>Your endpoint should look something like this: <strong>/data/yelp?location=location&term=term</strong></p>'''  
    else:
