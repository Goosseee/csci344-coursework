...
const evens = my_nums.filter(evenFilter);
...
//create a function that returns a list of screen names of statuses with at least 500 reteeets. 
//First to a filter then do a map 
